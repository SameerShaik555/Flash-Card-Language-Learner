...
try:
    ...
    original_data = pd.read_csv("data/Arabic -Eng.csv.csv")
...
def next_card():
    ...
    selected_card = current_card["Arabic"]
    ...
    window.after(100)
    audio_output = gTTS(text=current_card["Arabic"], lang=language)
...
def flip_card():
    ...
    audio_output.save("Arabic_word.mp3")
    playsound.playsound("Arabic_word.mp3", True)
    os.remove("Arabic_word.mp3")
...
card_title = canvas.create_text(400, 150, text="Arabic", font=("Ariel", 40, "italic"))
